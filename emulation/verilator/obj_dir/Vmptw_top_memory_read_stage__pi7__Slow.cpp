...
void Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__5(Vmptw_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__5\n"); );
...
void Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u__1(Vmptw_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u__1\n"); );
    Vmptw_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    IData/*31:0*/ __Vilp;
    // Body
...
void Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u__2(Vmptw_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u__2\n"); );
    Vmptw_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    IData/*31:0*/ __Vilp;
    // Body
...
void Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u__3(Vmptw_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u__3\n"); );
    Vmptw_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    IData/*31:0*/ __Vilp;
    // Body
...
void Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__4(Vmptw_top__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmptw_top_memory_read_stage__pi7::_settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__4\n"); );
    Vmptw_top* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    IData/*31:0*/ __Vilp;
    // Body
...
void Vmptw_top_memory_read_stage__pi7::_ctor_var_reset() {
    ...
    __PVT__valid_counter_q = VL_RAND_RESET_I(7);
    __PVT__valid_counter_d = VL_RAND_RESET_I(7);
    __PVT__spec_transaction_cnt_q = VL_RAND_RESET_I(7);
    __PVT__spec_transaction_cnt_d = VL_RAND_RESET_I(7);
    __PVT__stage_usage = VL_RAND_RESET_I(7);
    ...
    __PVT__grant_fifo_u__DOT__read_pointer_n = VL_RAND_RESET_I(6);
    __PVT__grant_fifo_u__DOT__read_pointer_q = VL_RAND_RESET_I(6);
    __PVT__grant_fifo_u__DOT__write_pointer_n = VL_RAND_RESET_I(6);
    __PVT__grant_fifo_u__DOT__write_pointer_q = VL_RAND_RESET_I(6);
    __PVT__grant_fifo_u__DOT__status_cnt_n = VL_RAND_RESET_I(7);
    __PVT__grant_fifo_u__DOT__status_cnt_q = VL_RAND_RESET_I(7);
    VL_RAND_RESET_W(17920, __PVT__grant_fifo_u__DOT__mem_n);
    VL_RAND_RESET_W(17920, __PVT__grant_fifo_u__DOT__mem_q);
    VL_RAND_RESET_W(280, grant_fifo_u__DOT____Vlvbound1);
    __PVT__valid_fifo_u__DOT__gate_clock = VL_RAND_RESET_I(1);
    __PVT__valid_fifo_u__DOT__read_pointer_n = VL_RAND_RESET_I(6);
    __PVT__valid_fifo_u__DOT__read_pointer_q = VL_RAND_RESET_I(6);
    __PVT__valid_fifo_u__DOT__write_pointer_n = VL_RAND_RESET_I(6);
    __PVT__valid_fifo_u__DOT__write_pointer_q = VL_RAND_RESET_I(6);
    __PVT__valid_fifo_u__DOT__status_cnt_n = VL_RAND_RESET_I(7);
    __PVT__valid_fifo_u__DOT__status_cnt_q = VL_RAND_RESET_I(7);
    VL_RAND_RESET_W(17920, __PVT__valid_fifo_u__DOT__mem_n);
    VL_RAND_RESET_W(17920, __PVT__valid_fifo_u__DOT__mem_q);
