...
#ifndef _VMPTW_TOP_MEMORY_READ_STAGE__PI8_H_
#define _VMPTW_TOP_MEMORY_READ_STAGE__PI8_H_  // guard
...
VL_MODULE(Vmptw_top_memory_read_stage__pi8) {
  public:
    ...
    WData/*8959:0*/ __PVT__grant_fifo_u__DOT__mem_n[280];
    WData/*8959:0*/ __PVT__grant_fifo_u__DOT__mem_q[280];
    WData/*8959:0*/ __PVT__valid_fifo_u__DOT__mem_n[280];
    WData/*8959:0*/ __PVT__valid_fifo_u__DOT__mem_q[280];
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vmptw_top_memory_read_stage__pi8);  ///< Copying not allowed
  public:
    Vmptw_top_memory_read_stage__pi8(const char* name = "TOP");
    ~Vmptw_top_memory_read_stage__pi8();
    
    // INTERNAL METHODS
    void __Vconfigure(Vmptw_top__Syms* symsp, bool first);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u__12(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u__27(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u__13(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u__28(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u__14(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u__29(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__15(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__30(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__11(Vmptw_top__Syms* __restrict vlSymsp);
    void _combo__TOP__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__26(Vmptw_top__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u__22(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u__37(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u__23(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u__38(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u__24(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u__39(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__25(Vmptw_top__Syms* __restrict vlSymsp);
    void _sequent__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__40(Vmptw_top__Syms* __restrict vlSymsp);
    ...
    void _sequent__TOP__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__36(Vmptw_top__Syms* __restrict vlSymsp);
    ...
    void _settle__TOP__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u__5(Vmptw_top__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__1(Vmptw_top__Syms* __restrict vlSymsp) VL_ATTR_COLD;
