...
void vmem_protocol(vmem_t * Memory, Vmpt32_top *tb){
...
void vmem_data_protocol(vmem_t * Memory, Vmpt32_top *tb){
				...
				if (Memory->mem_op == DATA_PORT_READ) {
					...
					switch (Memory->mem_strb) {
						...
						case 0x03: case 0x0C: case 0x30: case 0xC0: {
							...
							if (Memory->log)
								fprintf(Memory->log, "\n\t\t      [VMemory\t] LOAD: Data\t\t0x%016x - Address 0x%08lx - Byte Enable 0x%02x",
