...
VL_MODULE(Vmptw_top_memory_read_stage__pi7) {
  public:
    ...
    VL_INW(stage_slave_data,278,0,9);
    VL_OUTW(stage_master_data,278,0,9);
    ...
    WData/*278:0*/ __PVT__req_reg__DOT__reg_data_q[9];
    WData/*278:0*/ __PVT__req_reg__DOT__reg_data_d[9];
    WData/*278:0*/ __PVT__grant_fifo_to_valid_fifo[9];
    WData/*278:0*/ __PVT__valid_fifo_to_master[9];
    QData/*32:0*/ __PVT__valid_counter_q;
    QData/*32:0*/ __PVT__valid_counter_d;
    QData/*32:0*/ __PVT__stage_usage;
    WData/*1115:0*/ __PVT__grant_fifo_u__DOT__mem_n[35];
    WData/*1115:0*/ __PVT__grant_fifo_u__DOT__mem_q[35];
    WData/*1115:0*/ __PVT__valid_fifo_u__DOT__mem_n[35];
    WData/*1115:0*/ __PVT__valid_fifo_u__DOT__mem_q[35];
    
    // LOCAL VARIABLES
    WData/*278:0*/ __Vcellout__grant_fifo_u__data_o[9];
    WData/*278:0*/ grant_fifo_u__DOT____Vlvbound1[9];
    WData/*278:0*/ valid_fifo_u__DOT____Vlvbound1[9];
