...
VL_CTOR_IMP(Vmptw_top) {
    ...
    VL_CELL(__PVT__mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u, Vmptw_top_memory_read_stage__pi6);
    VL_CELL(__PVT__mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_stage_u__DOT__mem_stage_u, Vmptw_top_memory_read_stage__pi6);
    VL_CELL(__PVT__mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_stage_u__DOT__mem_stage_u, Vmptw_top_memory_read_stage__pi6);
    VL_CELL(__PVT__mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_stage_u__DOT__mem_stage_u, Vmptw_top_memory_read_stage__pi6);
    VL_CELL(__PVT__mptw_top__DOT__gen_walking_stages__BRA__3__KET____DOT__walking_stage_u__DOT__mem_stage_u, Vmptw_top_memory_read_stage__pi6);
...
void Vmptw_top::_settle__TOP__1(Vmptw_top__Syms* __restrict vlSymsp) {
    ...
    WData/*287:0*/ __Vtemp168[9];
    WData/*287:0*/ __Vtemp170[9];
    WData/*287:0*/ __Vtemp172[9];
    WData/*287:0*/ __Vtemp174[9];
    // Body
    ...
    if ((0x20U & vlTOPp->mptw_top__DOT__walking_stage_data
         [4U][4U])) {
        __Vtemp166[0U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][0U];
        __Vtemp166[1U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][1U];
        __Vtemp166[2U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][2U];
        __Vtemp166[3U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][3U];
        __Vtemp166[4U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][4U];
        __Vtemp166[5U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][5U];
        __Vtemp166[6U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][6U];
        __Vtemp166[7U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][7U];
        __Vtemp166[8U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [4U][8U];
    ...
    if ((0x20U & vlTOPp->mptw_top__DOT__walking_stage_data
         [0U][4U])) {
        __Vtemp168[0U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][0U];
        __Vtemp168[1U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][1U];
        __Vtemp168[2U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][2U];
        __Vtemp168[3U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][3U];
        __Vtemp168[4U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][4U];
        __Vtemp168[5U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][5U];
        __Vtemp168[6U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][6U];
        __Vtemp168[7U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][7U];
        __Vtemp168[8U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [0U][8U];
    ...
    if ((0x20U & vlTOPp->mptw_top__DOT__walking_stage_data
         [1U][4U])) {
        __Vtemp170[0U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][0U];
        __Vtemp170[1U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][1U];
        __Vtemp170[2U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][2U];
        __Vtemp170[3U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][3U];
        __Vtemp170[4U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][4U];
        __Vtemp170[5U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][5U];
        __Vtemp170[6U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][6U];
        __Vtemp170[7U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][7U];
        __Vtemp170[8U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [1U][8U];
    ...
    if ((0x20U & vlTOPp->mptw_top__DOT__walking_stage_data
         [2U][4U])) {
        __Vtemp172[0U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][0U];
        __Vtemp172[1U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][1U];
        __Vtemp172[2U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][2U];
        __Vtemp172[3U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][3U];
        __Vtemp172[4U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][4U];
        __Vtemp172[5U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][5U];
        __Vtemp172[6U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][6U];
        __Vtemp172[7U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][7U];
        __Vtemp172[8U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [2U][8U];
    ...
    if ((0x20U & vlTOPp->mptw_top__DOT__walking_stage_data
         [3U][4U])) {
        __Vtemp174[0U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][0U];
        __Vtemp174[1U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][1U];
        __Vtemp174[2U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][2U];
        __Vtemp174[3U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][3U];
        __Vtemp174[4U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][4U];
        __Vtemp174[5U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][5U];
        __Vtemp174[6U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][6U];
        __Vtemp174[7U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][7U];
        __Vtemp174[8U] = vlTOPp->mptw_top__DOT__walking_stage_data
            [3U][8U];
...
void Vmptw_top::_ctor_var_reset() {
    ...
    mptw_top__DOT__issue_to_backend_ready = VL_RAND_RESET_I(1);
    ...
    mptw_top__DOT__retire_stage_u__DOT__issue_reg__DOT__current_state = VL_RAND_RESET_I(1);
    mptw_top__DOT__retire_stage_u__DOT__issue_reg__DOT__next_state = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(279, mptw_top__DOT__retire_stage_u__DOT__issue_reg__DOT__reg_data_q);
    VL_RAND_RESET_W(279, mptw_top__DOT__retire_stage_u__DOT__issue_reg__DOT__reg_data_d);
    mptw_top__DOT__retire_stage_u__DOT__issue_reg__DOT__dummy = VL_RAND_RESET_I(1);
