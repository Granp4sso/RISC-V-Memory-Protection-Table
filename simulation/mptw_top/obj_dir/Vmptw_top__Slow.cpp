...
void Vmptw_top::_ctor_var_reset() {
    ...
    mptw_top__DOT____Vcellout__gen_walking_stages__BRA__0__KET____DOT__walking_reg__m_data_valid = VL_RAND_RESET_I(1);
    mptw_top__DOT____Vcellout__gen_walking_stages__BRA__0__KET____DOT__walking_reg__s_data_ready = VL_RAND_RESET_I(1);
    mptw_top__DOT____Vcellout__gen_walking_stages__BRA__1__KET____DOT__walking_reg__m_data_valid = VL_RAND_RESET_I(1);
    mptw_top__DOT____Vcellout__gen_walking_stages__BRA__1__KET____DOT__walking_reg__s_data_ready = VL_RAND_RESET_I(1);
    mptw_top__DOT____Vcellout__gen_walking_stages__BRA__2__KET____DOT__walking_reg__m_data_valid = VL_RAND_RESET_I(1);
    mptw_top__DOT____Vcellout__gen_walking_stages__BRA__2__KET____DOT__walking_reg__s_data_ready = VL_RAND_RESET_I(1);
    ...
    VL_RAND_RESET_W(196, mptw_top__DOT__plb_lookup_stage_u__DOT__mem_stage_u__DOT__valid_fifo_data_in);
    ...
    mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_reg__DOT__current_state = VL_RAND_RESET_I(1);
    mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_reg__DOT__next_state = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(196, mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_reg__DOT__reg_data_q);
    VL_RAND_RESET_W(196, mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_reg__DOT__reg_data_d);
    mptw_top__DOT__gen_walking_stages__BRA__0__KET____DOT__walking_reg__DOT__dummy = VL_RAND_RESET_I(1);
    mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_reg__DOT__current_state = VL_RAND_RESET_I(1);
    mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_reg__DOT__next_state = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(196, mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_reg__DOT__reg_data_q);
    VL_RAND_RESET_W(196, mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_reg__DOT__reg_data_d);
    mptw_top__DOT__gen_walking_stages__BRA__1__KET____DOT__walking_reg__DOT__dummy = VL_RAND_RESET_I(1);
    mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_reg__DOT__current_state = VL_RAND_RESET_I(1);
    mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_reg__DOT__next_state = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(196, mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_reg__DOT__reg_data_q);
    VL_RAND_RESET_W(196, mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_reg__DOT__reg_data_d);
    mptw_top__DOT__gen_walking_stages__BRA__2__KET____DOT__walking_reg__DOT__dummy = VL_RAND_RESET_I(1);
    __Vchglast__TOP__mptw_top__DOT__walking_stage_ready = VL_RAND_RESET_I(4);
